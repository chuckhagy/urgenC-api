...
class UserService {
    ...
    async updateById(params, body, authenticatedUserId) {
        ...
        try {
            ...
            if(parseInt(thisGoal.ownerUserId) !== authenticatedUserId) throw new Error('PERMISSION_DENIED');
    ...
    async deleteById(params, authenticatedUserId) {
        ...
        try {
            ...
            if(authenticatedUserId !== thisGoal.ownerUserId) throw new Error('PERMISSION_DENIED');
            let deletedGoal = await this.goalAssignmentRepository.deleteById(id);
            return deletedGoal
        } catch (error) {
            throw error;
        }
