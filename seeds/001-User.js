    ...
    return knex('User').del()
        .then(function () {
            return knex('User').insert([
                {role: 'admin', username: 'chuckhagy', hashedPassword: '$2a$10$sMcezAa4d2XsUD/uAS41te5tVH0qeE4z9VoR.bv5bP7T.EfFfUAdm', displayName: 'Chuck Hagy', profileColor:'#c90000', statusMessage: 'Crushing. It.', email: 'chuckhagy@gmail.com'},
