  ...
  return knex('Goal').del()
    .then(function () {
      return knex('Goal').insert([
          ...
          // {title: 'Buy a new friend', body: 'N/A', dueDate: '2017-12-20T16:30:00.000Z', priority: 2, ownerUserId: 3},
          // {title: 'Buy a new phone', body: 'N/A', dueDate: '2017-12-11T16:30:00.000Z', priority: 4, ownerUserId: 4},
          // {title: 'Buy a new drink', body: 'N/A', dueDate: '2017-12-15T16:30:00.000Z', priority: 1, ownerUserId: 4},
      ]);
    });
};
